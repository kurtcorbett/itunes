        ...
        this.getSongs = function (artist) {
            return $http.jsonp('https://itunes.apple.com/search?term=' + artist + '&callback=JSON_CALLBACK')
                .then(function (result) {
                    ...
                    var myData = result.data.results;
                    return myData.map(function (myData) {
                        return {
                            AlbumArt: myData.artworkUrl100,
                            Artist: myData.artistName,
                            Collection: myData.collectionName,
                            CollectionPrice: myData.collectionPrice,
                            Play: myData.previewUrl,
                            Type: myData.kind
                        };
                    });
                });
